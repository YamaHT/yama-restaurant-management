        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Shipping_Delivery_DeliveryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Table_TableType_TypeId",
                        column: x => x.TypeId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActualPayment = table.Column<decimal>(type: "numeric(10,2)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Order_UserVoucher_UserVoucherId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shipping_DeliveryId",
                table: "Shipping",
                column: "DeliveryId");

            migrationBuilder.CreateIndex(
                name: "IX_Table_TypeId",
                table: "Table",
                column: "TypeId");
