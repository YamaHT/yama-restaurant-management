    ...
    return (
        <Box sx={{ mt: 8, p: 3, width: 240 }}>
            ...
            <FormControl fullWidth sx={{ mb: 3, mt: 1 }}>
                <InputLabel  sx={{ ml: 1,  backgroundColor: 'rgba(236, 236, 236, 1)', paddingRight: '4px' }}>Table Type</InputLabel>
                <Select
                    value={filterOption}
            ...
            {/* Sorting Options */}
            <FormControl fullWidth sx={{ mb: 3, mt: 1 }}>
                <InputLabel  sx={{ ml: 1,  backgroundColor: 'rgba(236, 236, 236, 1)', paddingRight: '4px' }}>Sort By</InputLabel>
                <Select
                    value={sortOption}
